...
class WandbLogger():
    ...
    def map_val_table_path(self):
        ...
        for i, data in enumerate(tqdm(self.val_table.data,disable=True)):
    ...
    def create_dataset_table(self, dataset: LoadImagesAndLabels, class_to_id: Dict[int,str], name: str = 'dataset'):
        ...
        img_files = tqdm([dataset.path],disable=True) if isinstance(dataset.path, str) and Path(dataset.path).is_dir() else None
        img_files = tqdm(dataset.img_files,disable=True) if not img_files else img_files
        ...
        for si, (img, labels, paths, shapes) in enumerate(tqdm(dataset,disable=True)):
